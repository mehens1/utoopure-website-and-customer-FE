import { APP_NAME, APP_TAGLINE, CONTACT_INFO, SOCIAL_MEDIA } from "../constants/appConfig";
        ...
        >
          <div className="row g-4">
            <div className="col-lg-3">
              <a href="#">
                <h1 className="text-primary mb-0">{APP_NAME}</h1>
        ...
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <div className="footer-item">
              <h4 className="text-light mb-3">About Us!</h4>
              <p className="mb-4">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="footer-item">
              ...
              <p>Email: <a href={`mailto:${CONTACT_INFO.info_email}`}>{CONTACT_INFO.info_email}</a></p>
              <p>
                Phone:{" "}
                {CONTACT_INFO.phone.map((num, index) => (
                  <span key={num}>
                    <a href={`tel:${num}`}>{num}</a>
                    {index < CONTACT_INFO.phone.length - 1 ? ", " : ""}
                  </span>
                ))}
              </p>
